                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr v-for="maquina in maquinas" v-else :key="maquina.id" class="border-b hover:bg-gray-50">
                            <td class="p-4">
                                <img v-if="maquina.foto" :src="`/storage/${maquina.foto}`" :alt="maquina.nombre"
                            ...
                            <td class="p-4">
                                <span :class="getEstadoBadge(maquina.estado)"
                            ...
                            <td class="p-4">
                                <div class="flex gap-2">
                                    <a :href="`/planta/${maquina.id}/getInfo`"
                                        class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">
                                        Ver Info
                                    </a>
                                    <a :href="`/maquinas/${maquina.id}/edit`"
                                        class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded text-sm">
                                        Editar
                                    </a>
                                    <button @click="eliminar(maquina.id)"
